...
import com.aca.rest.service.AwsService;
import com.aca.rest.service.ProjectCustomerService;
...
public class ProjectCustomerController {
	...
	public List<ProjectCustomer> getAllCustomers(){
		...
		ProjectCustomerService service = new ProjectCustomerService();
		List<ProjectCustomer> customers = service.getAllCustomers();
	...
	@POST
	@Produces({MediaType.APPLICATION_JSON})
	public int emailMessage(EmailMessage message){
